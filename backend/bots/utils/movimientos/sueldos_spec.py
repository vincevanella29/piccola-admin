...
_ALLOWED_GROUPS = {
    "auto","none","mes","sigla","seccion","cargo","sexo","afp","isapre","rut",
    "mes_sigla","sigla_seccion","sigla_afp","sigla_cargo"
}
...
SPEC = FilterSpec(
    ...
    schema_text=(
        '{'
          '"period":{'
            ...
            '"tz":"America/Santiago"'
          '},'
          '"group_by":"auto"|"none"|"mes"|"sigla"|"seccion"|"cargo"|"sexo"|"afp"|"isapre"|"rut"|"mes_sigla"|"sigla_seccion"|"sigla_afp"|"sigla_cargo",'
    ...
    rules_text=(
        ...
        "- 'por local/sucursal/sigla' => group_by='sigla'; 'por mes y por local' => 'mes_sigla'; "
