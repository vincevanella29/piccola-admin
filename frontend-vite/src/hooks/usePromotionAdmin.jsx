...
import { createPromotion, updatePromotion, fetchAllPromotions, reactivateCoupon, fetchCoupons, fetchApiToken as fetchApiTokenApi, generateApiToken as generateApiTokenApi } from '../utils/promotionsData';
...
export function usePromotionAdmin(appState, t) {
  ...
  const refetchAllPromotions = async ({ page = 1,
    ...
    try {
      ...
      // Convert rules.amount from base units to human-readable
